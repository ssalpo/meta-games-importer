<x-layouts.app title="Создать аккаунт">
    <div class="mb-8 flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-950">Создать аккаунт</h1>
            <p class="mt-2 text-sm text-zinc-600">Добавьте аккаунт сервиса и сохраните его токен доступа.</p>
        </div>
    ...
    <form method="POST" action="{{ route('accounts.store') }}" class="max-w-2xl rounded-md border border-zinc-200 bg-white p-6 shadow-sm">
