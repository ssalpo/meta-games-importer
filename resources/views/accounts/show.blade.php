<x-layouts.app title="Просмотр аккаунта">
    <div class="mb-8 flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-950">{{ $account->name }}</h1>
            <p class="mt-2 text-sm text-zinc-600">Данные аккаунта и состояние токена доступа.</p>
        </div>
